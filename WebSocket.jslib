...
SocketCreate: function(url)
{
	...
	socket.socket.onopen = function () {
		gameInstance.SendMessage("ActionCable", "OnOpen", "");
	};
	socket.socket.onmessage = function (e) {
        ...
        gameInstance.SendMessage("ActionCable", "OnMessage", "");
	...
	socket.socket.onclose = function (e) {
		...
		gameInstance.SendMessage("ActionCable", "OnClose", "");
	}
	var instance = webSocketInstances.push(socket) - 1;
	return instance;
},
PostMessageToWindow: function (socketInstance, ptr, length)
{
	var messageString = Pointer_stringify(ptr);
	window.postMessage(messageString, "*");
},
SocketCnt: function ()
{
	return webSocketInstances.length;
},
...
SocketSend: function (socketInstance, ptr, length)
{
    ...
    socket.socket.send(Pointer_stringify(ptr));
},
